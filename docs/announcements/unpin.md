# `$uptimeRobot->announcements->unpin()`

> UptimeRobot API v3 · `POST /psps/{pspId}/announcements/{id}/unpin`
...
| `$id` | `int` | yes | ID of the announcement to unpin |
...
$uptimeRobot->announcements->unpin(statusPageId: 123, id: 123);
```
