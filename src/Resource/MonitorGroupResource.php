...
final class MonitorGroupResource extends AbstractResource
{
     ...
     * @param int|null $monitorsNewGroupId The group the monitors of the deleted group move to, at least 1: 0 is rejected with a BadRequestException (verified live). Without it, they move to no group (groupId 0), which the specification calls the default group.
     */
